...
TvcTest::TvcTest()
    : startedMs(0), durationMs(0), lastYaw(0), lastPitch(0), maxYaw(5), minYaw(-5), maxPitch(5), minPitch(-5), stepSizeYaw(0), stepSizePitch(0), yawDirection(true), pitchDirection(true)
{
}
